...
import { ImageAssets, PredictionDataInterface } from "./utils";
...
async function generateFigmaElements(data: Array<PredictionDataInterface>, artBoardWidth: number, artBoardHeight: number, imgAssets: ImageAssets, stylePreference:any) {
...
async function renderElementsOnScreen(predictionData: any, imgAssets: ImageAssets, stylePreference:any) {
